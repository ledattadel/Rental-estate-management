...
public interface IUserService {
    ...
    void assignmentBuilding(AssignmentBuildingRequest request);
    Map<Long, String> findAllStaff();
    List<StaffResponseDTO> getCustomerStaffs (long customerId);
    void assignmentCustomer(AssignmentCustomerRequest request);
